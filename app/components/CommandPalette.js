...
export default function CommandPalette() {
  ...
  const commands = useMemo(() => [
    ...
    { id: "wallboard", icon: "🔴", title: isId ? "Monitor NOC Wallboard Fullscreen" : "Fullscreen Live NOC Wallboard", category: isId ? "Monitoring" : "Monitoring", run: () => window.dispatchEvent(new Event("open-noc-wallboard")) },
    { id: "resume", icon: "📄", title: isId ? "Buka & Cetak CV ATS (Print to PDF)" : "View & Print ATS Resume (A4)", category: isId ? "Resume" : "Resume", run: () => window.dispatchEvent(new Event("open-resume-modal")) },
    { id: "insiden", icon: "🚨", title: isId ? "Skenario Kasus Troubleshooting NOC" : "Interactive NOC Incident Troubleshooting", category: isId ? "Kasus" : "Case Studies", action: "#insiden" },
    { id: "traceroute", icon: "📡", title: isId ? "Simulator Traceroute & Rute BGP" : "Hop-by-Hop Traceroute Simulator", category: isId ? "Tools" : "Tools", action: "#tools" },
    ...
    { id: "fiber", icon: "⚡", title: isId ? "Kalkulator Redaman Fiber Optik & OTDR" : "Fiber Loss & OTDR Waveform Calc", category: isId ? "Tools" : "Tools", action: "#tools" },
